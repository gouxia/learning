<template>
  <div class="goods">
    ...
    <div class="foods-wrapper">
      ...
      <div class="foods-item" @click="showFood">
        <div class="left">
          <img src="../../../src/assets/01.png" />
        </div>
        <div class="right">
          <div class="foods-name">
            <span>皮蛋瘦肉粥配包子套餐</span>
          </div>
          ...
          <div class="foods-xiaoliang">
            <span>月售1132份</span>
            <span style="margin-left:12px;">好评率100%</span>
          </div>
          <div class="foods-jiage">
           <div style="color:red; font-weight: normal; font-size: 14px;line-height: 24px;">
              ￥10
            </div>
             <span style="text-decoration:line-through;color:rgb(147,153,159);line-height:24px;font-size:10px;font-weight:normal;">
               ￥28
               </span>
            <div class="jia">
              <img src="../../../src/assets/jia.png" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="foods-item">
        ...
        <div class="right">
          ...
          <div class="foods-xiaoliang">
            <span class="xiaoliang">月售1132份</span>
            <span style="margin-left:12px;">好评率100%</span>
          </div>
